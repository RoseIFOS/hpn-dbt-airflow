...
# .env fica no projeto vizinho hpn-dbt-dw
load_dotenv(Path(__file__).resolve().parent.parent / "hpn-dbt-dw" / ".env")

TABLES =["dbo.account","dbo.account_header", "dbo.customer", "dbo.department_group", "dbo.finance", "dbo.geography", "dbo.organization", "dbo.product", "dbo.product_sub_category", "dbo.product_cost_history", "dbo.region", "dbo.sales_details", "dbo.sales_header", "dbo.sales_returns"]
